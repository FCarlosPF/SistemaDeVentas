...
public class LoginVista extends javax.swing.JFrame {
    ...
    public void validar(){
        ...
        if(txtCorreo!=null && txtPass!=null){   
        String busqueda = logindao.login(txtCorreo.getText(), String.valueOf(txtPass.getText()));
        if(busqueda.equals("Usuario Encontrado")){
        String busquedaNombre=logindao.buscarNombre(txtCorreo.getText());
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 10, 290, 420));
        ...
        jLabel9.setText("Ventas Don Máximo");
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 0, 320, 440));
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 380, 252, -1));
